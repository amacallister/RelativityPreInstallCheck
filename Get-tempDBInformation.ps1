function Get-tempDBInformation {  
    <#
        .SYNOPSIS
        This commandlet returns the tempDB Information for a list of computers.
        .DESCRIPTION
        This commandlet returns the tempDB Information for a list of computers. This includes the tempDB name, growth in MB, and auto-growth.
        ...
        .EXAMPLE
        Get-tempDBInformation -computerName computer1, computer2 -serverRole role -credential credential
    #>
    ...
    Process {
        ...
        $requirement = "tempDB Information"
            ...
            if ($PSCmdlet.ShouldProcess($computer)){                
                ...
                $Script = {                                                           
                    ...
                    try {
                        ...
                        $sqlQuery = "SELECT name, ((size*8)/1024) as 'size', growth, is_percent_growth FROM tempdb.sys.database_files"
                    ...
                    $name = $sqlResult.name
                    $size = $sqlResult.size
                    $growth = $sqlResult.growth
                    $percent = $sqlResult.is_percent_growth
                    $output = "tempDB Name: $name" + "`r`n" + "Size: $size MB" + "`r`n" + "Growth: $freeSpace MB" + "`r`n" + "Percentage Growth: $percent"
                    ...
                    Write-Host "The tempDB Information for $computer has been checked." -ForegroundColor "DarkCyan"
        ...
        Write-Host "The tempDB Information in all computers has been checked." -ForegroundColor "DarkCyan"
        Write-Host "All information was added to c:\output.csv". -ForegroundColor "DarkCyan"

    } # End Process Block

} # End Get-tempDBInformation function
...
#Get-tempDBInformation -computerName emttest, localhost -serverRole "web" -credential $credential
