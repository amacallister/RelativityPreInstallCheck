function Get-RelativitySqlAccountPermissions {  
    <#
        .SYNOPSIS
        This commandlet returns the Relativity SQL Account Permissions for a list of computers.
        .DESCRIPTION
        This commandlet returns the Relativity SQL Account Permissions for a list of computers. This includes the name and login type.
        ...
        .OUTPUTS
        Outputs the Relativity SQL Account Permissions for a list of computers in a file called output.csv.
        .EXAMPLE
        Get-RelativitySqlAccountPermissions -computerName computer -serverRole role -credential credential
        .EXAMPLE
        Get-RelativitySqlAccountPermissions -computerName computer1, computer2 -serverRole role -credential credential
    #>
    ...
    Process {
        ...
        $requirement = "Relativity SQL Account Permissions"

        # Set a computer counter in order to match the correct credentials to the correct computer
        $computerCounter = 0
       
        # Get the Relativity SQL Account Permissions
        foreach ($computer in $computerName) {
            ...
            if ($PSCmdlet.ShouldProcess($computer)){                
                ...
                $Script = {                                                           
                    ...
                    Write-Host "The Relativity SQL Account Permissions for $computer has been checked." -ForegroundColor "DarkCyan"
        ...
        Write-Host "The Relativity SQL Account Permissions in all computers has been checked." -ForegroundColor "DarkCyan"
        Write-Host "All information was added to c:\output.csv". -ForegroundColor "DarkCyan"

    } # End Process Block

} # End Get-RelativitySqlAccountPermissions function
...
#Get-RelativitySqlAccountPermissions -computerName emttest -serverRole "web" -credential $credential
