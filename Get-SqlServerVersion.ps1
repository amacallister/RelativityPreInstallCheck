function Get-SqlServerVersion {  
    <#
        .SYNOPSIS
        This commandlet returns the SQL Server Version for a list of computers.
        .DESCRIPTION
        This commandlet returns the SQL Server Version for a list of computers.
        ...
        .RETURN
        Outputs the SQL Server Version for a list of computers in a file called output.csv.
        .EXAMPLE
        Get-SqlServerVersion -computerName computer -serverRole role -credential credential
        .EXAMPLE
        Get-SqlServerVersion -computerName computer1, computer2 -serverRole role -credential credential
    #>
    ...
    Process {
        ...
        foreach ($computer in $computerName) {
            ...
            if ($PSCmdlet.ShouldProcess($computer)){                
                ...
                $Script = {                                                           
                    ...
                    Write-Host "The SQL Server Version for $computer has been checked." -ForegroundColor "DarkCyan"
        ...
        Write-Host "The SQL Server Version in all computers has been checked." -ForegroundColor "DarkCyan"
        Write-Host "All information was added to c:\output.csv". -ForegroundColor "DarkCyan"

    } # End Process Block

} # End Get-SqlServerVersion function
...
#Get-SqlServerVersion -computerName emttest, localhost -serverRole "web" -credential $credential
