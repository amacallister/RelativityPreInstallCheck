...
function Start-ServiceBusPreInstallCheck { 
    ...
    Get-DtcEnabledStatus -computerName $computerName -serverRole $serverRole
    Get-ServiceBusConfig -computerName $computerName -serverRole $serverRole
    Get-ServiceBusServicesRunningStatus -computerName $computerName -serverRole $serverRole
    Get-ServiceBusVersion -computerName $computerName -serverRole $serverRole
    Get-ServiceBusCertStatus -computerName $computerName -serverRole $serverRole
    Get-ServiceBusDNSAccessibility -computerName $computerName -serverRole $serverRole
    ...
    Get-TempDriveLocation -computerName $computerName -serverRole $serverRole
