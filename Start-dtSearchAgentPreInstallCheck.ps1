...
function Start-dtSearchAgentPreInstallCheck { 
    <#
        .SYNOPSIS
        This commandlet runs all scripts for the dtSearch Agent server role Pre-Install Check.
        .DESCRIPTION
        This commandlet runs all scripts for the dtSearch Agent server role Pre-Install Check.
        ...
        .EXAMPLE
        Start-dtSearchAgentPreInstallCheck -computerName computer -serverRole serverRole -rolesAndFeatures role
    #>
    ...
    # Call all scripts for dtSearch Agent Pre-Install Check
