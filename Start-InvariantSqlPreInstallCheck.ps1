...
function Start-InvariantSqlPreInstallCheck { 
    <#
        .SYNOPSIS
        This commandlet runs all scripts for the Invariant SQL server role Pre-Install Check.
        .DESCRIPTION
        This commandlet runs all scripts for the Invariant SQL server role Pre-Install Check.
        ...
        .EXAMPLE
        Start-InvariantSqlPreInstallCheck -computerName computer -serverRole serverRole -credential $credential
    #>
    ...
    # Call all scripts for Invariant SQL Pre-Install Check
    ...
    Get-SharePermissions -computerName $computerName -serverRole $serverRole
    ...
    Get-DtcEnabledStatus -computerName $computerName -serverRole $serverRole   
    ...
    Get-SqlServiceLogonAsAccount -computerName $computerName -serverRole $serverRole
    Get-EddsdboAccount -computerName $computerName -serverRole $serverRole -credential $credential
    Get-EddsdboAccountPermissions -computerName $computerName -serverRole $serverRole -credential $credential
    Get-SaSqlAccount -computerName $computerName -serverRole $serverRole -credential $credential
    Get-RelativitySqlAccount -computerName $computerName -serverRole $serverRole -credential $credential
    Get-RelativitySqlAccountPermissions -computerName $computerName -serverRole $serverRole -credential $credential
    Get-SqlFullTextFilterDaemonLauncherServiceInstallStatus -computerName $computerName -serverRole $serverRole
    Get-SqlServerVersion -computerName $computerName -serverRole $serverRole -credential $credential
    Get-MixedModeAuthenticationStatus -computerName $computerName -serverRole $serverRole -credential $credential
    ...
    Get-OptimizeForAdHocWorkloads -computerName $computerName -serverRole $serverRole -credential $credential
    Get-MaxDegreeOfParallelism -computerName $computerName -serverRole $serverRole  -credential $credential
    Get-CostThresholdForParallelism -computerName $computerName -serverRole $serverRole -credential $credential
    Get-MaxServerMemory -computerName $computerName -serverRole $serverRole -credential $credential
    Get-tempDBInformation -computerName $computerName -serverRole $serverRole -credential $credential
    Get-InstantFileInitializationStatus -computerName $computerName -serverRole $serverRole
    Get-TcpChimneyOffloadingStatus -computerName $computerName -serverRole $serverRole
