...
function Start-AnalyticsPreInstallCheck { 
    <#
        .SYNOPSIS
        This commandlet runs all scripts for the Analytics server role Pre-Install Check.
        .DESCRIPTION
        This commandlet runs all scripts for the Analytics server role Pre-Install Check.
        ...
        .EXAMPLE
        Start-AnalyticsPreInstallCheck -computerName computer -serverRole serverRole -rolesAndFeatures role
    #>
    ...
    # Call all scripts for Analytics Pre-Install Check
