function Get-MixedModeAuthenticationStatus {  
    <#
        .SYNOPSIS
        This commandlet returns the Mixed Mode Authentication Status for a list of computers.
        .DESCRIPTION
        This commandlet returns the Mixed Mode Authentication Status for a list of computers.
        ...
        .RETURN
        Outputs the Mixed Mode Authentication Status for a list of computers in a file called output.csv.
        .EXAMPLE
        Get-MixedModeAuthenticationStatus -computerName computer -serverRole role -credential credential
        .EXAMPLE
        Get-MixedModeAuthenticationStatus -computerName computer1, computer2 -serverRole role -credential credential
    #>
    ...
    Process {
        ...
        $requirement = "Mixed Mode Authentication Status"

        # Set a computer counter in order to match the correct credentials to the correct computer
        $computerCounter = 0
       
        # Get the Mixed Mode Authentication Status value
        foreach ($computer in $computerName) {
            ...
            if ($PSCmdlet.ShouldProcess($computer)){                
                ...
                $Script = {                                                           
                    ...
                    # Getting Mixed Mode Authentication Status
                    try {
                        ...
                        $sqlQuery = "EXEC master.sys.xp_loginconfig 'login mode'"
                    ...
                    Write-Host "The Mixed Mode Authentication Status for $computer has been checked." -ForegroundColor "DarkCyan"
        ...
        Write-Host "The Mixed Mode Authentication Status in all computers has been checked." -ForegroundColor "DarkCyan"
        Write-Host "All information was added to c:\output.csv". -ForegroundColor "DarkCyan"

    } # End Process Block

} # End Get-MixedModeAuthenticationStatus function
...
#Get-MixedModeAuthenticationStatus -computerName emttest, localhost -serverRole "web" -credential $credential
