...
function Start-DistributedSqlPreInstallCheck { 
    ...
    Get-ListOfLinkedSQLServers -computerName $computerName -serverRole $serverRole -credential $credential
    Get-RemoteQueryTimeout -computerName $computerName -serverRole $serverRole -credential $credential
