...
function Start-CoreAgentPreInstallCheck { 
    <#
        .SYNOPSIS
        This commandlet runs all scripts for the Core Agent server role Pre-Install Check.
        .DESCRIPTION
        This commandlet runs all scripts for the Core Agent server role Pre-Install Check.
        ...
        .EXAMPLE
        Start-CoreAgentPreInstallCheck -computerName computer -serverRole serverRole -rolesAndFeatures role
    #>
    ...
    # Call all scripts for Core Agent Pre-Install Check
