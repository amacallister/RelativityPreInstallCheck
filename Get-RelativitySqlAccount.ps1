function Get-RelativitySqlAccount {  
    <#
        .SYNOPSIS
        This commandlet returns the Relativity SQL Account for a list of computers.
        .DESCRIPTION
        This commandlet returns the Relativity SQL Account for a list of computers. This includes the name and login type.
        ...
        .OUTPUTS
        Outputs the Relativity SQL Account for a list of computers in a file called output.csv.
        .EXAMPLE
        Get-RelativitySqlAccount -computerName computer -serverRole role -credential credential
        .EXAMPLE
        Get-RelativitySqlAccount -computerName computer1, computer2 -serverRole role -credential credential
    #>
    ...
    Process {
        ...
        foreach ($computer in $computerName) {
            ...
            if ($PSCmdlet.ShouldProcess($computer)){                
                ...
                $Script = {                                                           
                    ...
                    Write-Host "The Relativity SQL Account for $computer has been checked." -ForegroundColor "DarkCyan"
        ...
        Write-Host "The Relativity SQL Account in all computers has been checked." -ForegroundColor "DarkCyan"
        Write-Host "All information was added to c:\output.csv". -ForegroundColor "DarkCyan"

    } # End Process Block

} # End Get-RelativitySqlAccount function
...
#Get-RelativitySqlAccount -computerName emttest, localhost -serverRole "web" -credential $credential
