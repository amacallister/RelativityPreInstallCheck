...
function Start-ConversionAgentPreInstallCheck { 
    <#
        .SYNOPSIS
        This commandlet runs all scripts for the Conversion Agent server role Pre-Install Check.
        .DESCRIPTION
        This commandlet runs all scripts for the Conversion Agent server role Pre-Install Check.
        ...
        .EXAMPLE
        Start-ConversionAgentPreInstallCheck -computerName computer -serverRole serverRole -rolesAndFeatures role
    #>
    ...
    # Call all scripts for Conversion Agent Pre-Install Check
