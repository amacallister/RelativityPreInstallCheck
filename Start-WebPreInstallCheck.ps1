...
function Start-WebPreInstallCheck { 
    ...
    Get-ServerRolesAndFeatures -computerName $computerName -serverRole $serverRole -rolesAndFeatures $rolesAndFeatures
    Get-IISLogFileOptions -computerName $computerName -serverRole $serverRole
    Get-IISFailedRequestTracingRulesValue -computerName $computerName -serverRole $serverRole
    Get-IISExpirationHeaderInfo -computerName $computerName -serverRole $serverRole
    Get-IISWebBindingInfo -computerName $computerName -serverRole $serverRole
    Get-IISVersion -computerName $computerName -serverRole $serverRole
