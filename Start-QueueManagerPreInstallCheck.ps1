...
function Start-QueueManagerPreInstallCheck { 
    <#
        .SYNOPSIS
        This commandlet runs all scripts for the Queue Manager server role Pre-Install Check.
        .DESCRIPTION
        This commandlet runs all scripts for the Queue Manager server role Pre-Install Check.
        ...
        .EXAMPLE
        Start-QueueManagerPreInstallCheck -computerName computer -serverRole serverRole -credential $credential
    #>
    ...
    # Call all scripts for Queue Manager Pre-Install Check
